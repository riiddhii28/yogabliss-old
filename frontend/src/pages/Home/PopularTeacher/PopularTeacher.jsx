    ...
    <div className='md:w-[80%] mx-auto my-36'>
        <div>
            ...
            <div className='w-[40%] text-center mx-auto my-4'>
                <p className='text-gray-500'>Explore our popular classes. Here are some of the popular classes based on the people enrolled.</p>
            </div>
        </div>
                    ...
                    instructors?.slice(0,4).map((instructor, i) => (
                         ...
                         <div className='flex-col flex gap-6 md:gap-8'>
                            ...
                            <div className='flex flex-col text-center'>
                                ...
                                <p className='text-gray-500 mb-4 '>Total Students:{instructor?.totalEnrolled}</p>
                            </div>
                        </div>
                       </div>
                    ))

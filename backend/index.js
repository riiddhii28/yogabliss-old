...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@yogabliss.4ax0sou.mongodb.net/?retryWrites=true&w=majority&appName=yogabliss`;
...
async function run() {
  try {
    ...
    const database = client.db("yogabliss");
    ...
    //get classes by inst email address
